...
public class View2 {
    ...
    public static void main(String[] args) {
        try {
            // Obtener conexión a la base de datos y asegurar tabla
            Connection connection = DatabaseConnection.getConnection();
            DatabaseConnection.ensureUsuarios2Table();
            ...
            // Buscar usuario por ID solo si se asignó ID
            Usuario usuarioEncontrado = null;
            if (nuevoUsuario.getId() != null) {
                usuarioEncontrado = usuarioDAO.findById(nuevoUsuario.getId());
            }
